...
![VPC 생성 화면](./screenshots/core/01-vpc-created.png)
...
![서브넷 생성 완료](./screenshots/core/02-subnets-created.png)
...
![IGW 연결 완료](./screenshots/core/03-igw-attached.png)
...
![NAT 생성 완료](./screenshots/core/04-nat-gateway-created.png)
...
![Public Route Table - Routes](./screenshots/core/05-route-table-public-routes.png)
![Public Route Table - Associations](./screenshots/core/06-route-table-public-associations.png)
...
![Private App Route Table - Routes](./screenshots/core/07-route-table-private-app-routes.png)
![Private App Route Table - Routes](./screenshots/core/08-route-table-private-app-associations.png)
...
![Private DB Route Table - Routes](./screenshots/core/09-route-table-private-db-routes.png)
![Private DB Route Table - Routes](./screenshots/core/10-route-table-private-db-associations.png)
...
![ALB SG Inbound](./screenshots/core/11-sg-alb-inbound.png)
![ALB SG Outbound](./screenshots/core/12-sg-alb-outbound.png)
...
![APP SG Inbound](./screenshots/core/13-sg-app-inbound.png)  
![APP SG outbound](./screenshots/core/14-sg-app-outbound.png)  
...
![DB SG Inbound](./screenshots/core/15-sg-db-inbound.png)  
![DB SG Inbound](./screenshots/core/16-sg-db-outbound.png)  
...
![DB Subnet Group](./screenshots/core/17-db-subnet-group.png)
...
![RDS Created](./screenshots/core/18-rds-created.png)
![RDS Connectivity](./screenshots/core/19-rds-connectivity.png)
...
![Launch Template 개요](./screenshots/core/20-launch-template-overview.png)
![Launch Template User Data](./screenshots/core/21-launch-template-userdata.png)
...
![Target Group 개요](./screenshots/core/23-target-group-overview.png)
![Target Group Health Check](./screenshots/core/24-target-group-healthcheck.png)
...
![ALB Summary](./screenshots/core/25-alb-create-summary.png)
![ALB active](./screenshots/core/26-alb-active.png)
![ALB Target Group](./screenshots/core/27-alb-target-group.png)
...
![ASG 개요](./screenshots/core/28-asg-overview.png)
![ASG Network](./screenshots/core/29-asg-network-targetgroup.png)
...
![CloudWatch Alarms](./screenshots/core/32-cloudwatch-alarms-list.png)
...
![ASG Health Check](./screenshots/core/30-target-group-healthy.png)
![ALB Web Test](./screenshots/core/31-alb-web-test.png)